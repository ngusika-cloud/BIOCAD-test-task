...
В прототипе используется `openai/gpt-5.6-luna`. На 18 августа 2026 года [OpenRouter берёт $0,20 за миллион входных токенов и $1,20 за миллион выходных](https://openrouter.ai/openai/gpt-5.6-luna-20260709). Модель поддерживает tool calls и достаточно быстро применяет изменения, как требует задание. Результаты тестирования других моделей и план benchmark на сценариях BIOCAD собраны в [roadmap](docs/ROADMAP_TO_PRODUCTION.md).
